        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_message(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/chatter_message.Chat/SendMessage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("chatter_message.Chat", "SendMessage"));
...
pub mod chat_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/chatter_message.Chat/SendMessage" => {
                    ...
                    impl<T: Chat> tonic::server::UnaryService<super::Message>
    ...
    pub const SERVICE_NAME: &str = "chatter_message.Chat";
